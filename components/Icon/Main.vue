<template>
    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" style="display: none">
        ...
        <symbol id="icon-elipse" viewBox="0 0 20 20">
        ...
        <symbol id="icon-hide-sidebar" viewBox="0 0 20 20">
